document.addEventListener('DOMContentLoaded', () => {
    const planetsData = {
        ...
        'TRAPPIST-1e': {
            ...
            image1: './media/trappist-1e-primary.jpg',
        ...
        'HD 209458 b': {
            ...
            image1: './media/hd-209458b-primary.jpg',
        ...
        'WASP-12b': {
            ...
            image1: './media/wasp-12b-primary.jpg',
        ...
        '51 Pegasi b': {
            ...
            image1: './media/51pegasi-b-primary.jpg',
    ...
    function updatePlanetDetails(planetName) {
        ...
        setTimeout(() => {
            // Update the details area (text and links)
        ...
        }, 50); // Short delay for smoother transition effect
    }

    // Add click events to each planet name
    ...
    // Initial Load (Load details for the planet initially marked as active)
